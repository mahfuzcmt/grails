<form  class="edit-popup-form" action="${app.relativeBaseUrl()}liveChatAdmin/sendImmediatelyChatToMail" method="post">
    ...
    <div class="form-row mandatory mandatory-chosen-wrapper">
        ...
        <input name="recipient" type="text" class="medium" validation="required email">
    </div>
