...
<form  class="edit-popup-form" action="${app.relativeBaseUrl()}liveChatAdmin/sendInviteRequest" method="post">
    ...
    <div class="button-line">
        <button class="submit-button" type="submit"><g:message code="send.invitation"/></button>
