...
<div class="bmui-tab left-side-header" ${params.active ? "active='" + params.active + "'" : ""}>
    <div class="bmui-tab-header-container">
        ...
        <div class="bmui-tab-header" data-tabify-tab-id="agent" data-tabify-url="${app.relativeBaseUrl() + 'liveChatAdmin/loadAgent'}">
            <span class="title"><g:message code="active.supporters"/></span>
        </div>
        ...
        <div class="bmui-tab-header" data-tabify-tab-id="profile" data-tabify-url="${app.relativeBaseUrl() + 'liveChatAdmin/loadProfile'}">
            <span class="title"><g:message code="profile"/></span>
        </div>
    </div>
