<%@ page import="com.webcommander.admin.Operator; com.webcommander.plugin.live_chat.ChatTag; com.webcommander.admin.Customer" %>
        ...
        <g:if test="${chats}">
            <g:each in="${chats}" var="chat" status="i">
                <tr>
                    ...
                    <td>${chat.chatDepartment?.name.encodeAsBMHTML()}</td>
                    <td>${Operator.get(chat.agentId)?.fullName.encodeAsBMHTML()}</td>
