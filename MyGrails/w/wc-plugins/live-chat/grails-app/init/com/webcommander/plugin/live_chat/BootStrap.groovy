...
class BootStrap {
    ...
    List domain_constants = [
            [constant:"SITE_CONFIG_TYPES", key: "LIVE_CHAT", value: config_type],
    ...
    def tenantInit = { tenant ->
        ...
        Map initialData = [
                [LCD.CHAT_VISITOR_INFORMATION_CONFIG.ASK_INFO_BEFORE_CHAT_START]: "true",
                [LCD.OFFLINE_EMAIL_RECIPIENT]: StoreDetail.first()?.address?.email ?: null,
                [LCD.CHAT_ROUTING_CONFIG.CHAT_LIMIT] : 3,
                [LCD.CHAT_CONCIERGE_CONFIG.ONLINE_TITLE] : "Live Chat Support",
                [LCD.CHAT_CONCIERGE_CONFIG.OFFLINE_TITLE] : "Leave a Message",
                [LCD.CHAT_CONCIERGE_CONFIG.MESSAGE_STYLE] : [LCD.CHAT_MESSAGE_STYLE_VALUE.PLAIN_TEXT],
                [LCD.CHAT_CONCIERGE_CONFIG.POSITION] : [LCD.CHAT_BOX_POSITION_VALUE.Right_Bottom],
                [LCD.CHAT_CONCIERGE_CONFIG.ONLINE_BUTTON_TEXT] : "Start Chatting",
                [LCD.CHAT_CONCIERGE_CONFIG.OFFLINE_BUTTON_TEXT] : "Send Message"
        ]
...
//            new LargeData(identifire: LIVE_CHAT_IAPP_IDENTIFIRE, name: "iAppResource", content: data).save()
    ...
    def tenantDestroy = { tenant ->
        ...
        try {
            ...
            LiveChatResourceTagLib.RESOURCES_PATH.each { resource ->
    ...
    def init = { servletContext ->
        ...
        Holders.grailsApplication.mainContext.getBean(AppResourceTagLib).metaClass.mixin LiveChatResourceTagLib
