...
<div class="app-tab-content-container">
    <div class="three-column multi-column">
        <div class="first-column columns">
            <h3><g:message code="get.price"/></h3>
            <div class="info-content"><g:message code="section.text.get.price.info"/></div>
            ...
            <div class="column-content left-panel panel tree-panel with-title">
                ...
                <div class="local-category-tree"></div>
            </div>
        </div><div class="last-column columns">
            <div class="column-content right-panel panel tree-panel with-title">
                <div class="tree-title"><g:message code="getprice.category"/> </div>
                <div class="get-price-category-tree"></div>
            </div>
        </div>
    </div>
</div>
