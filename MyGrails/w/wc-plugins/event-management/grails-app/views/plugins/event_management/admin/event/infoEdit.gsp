<%@ page import="org.apache.commons.io.FilenameUtils; com.webcommander.webcommerce.TaxProfile; com.webcommander.admin.Operator" %>
<form action="${app.relativeBaseUrl()}eventAdmin/saveEvent" method="post" class="create-edit-form downloadable-spec-form" enctype="multipart/form-data">
                    ...
                    <div class="form-section-container">
                        <div class="double-input-row">
                            <div class="form-row mandatory">
                                ...
                                <label><g:message code="event.organiser"/><span class="suggestion"><g:message code="suggestion.event.organizer"/></span></label>
                                <ui:domainSelect class="large organiser-selector" name="organiser" domain="${Operator}" text="fullName" value="${event.organiser?.id}"/>
                            </div>
                        </div>
                        <div class="double-input-row">
                            <div class="form-row">
                        ...
                        <div class="double-input-row">
                            <div class="form-row">
                                ...
                                <input type="checkbox" class="single" name="disableTracking" value="true" uncheck-value="false" ${event.disableGooglePageTracking ? "checked=checked" : ""}/>
                            </div><div class="form-row">
                                <label>&nbsp;</label>
                        ...
                        <div class="form-row show-purchase-option">
                            <label>&nbsp;</label>
                            <input toggle-target="show-tax-profile" class="single" type="checkbox" name="isPurchasable" value="true" uncheck-value="false" ${event.isPurchasable ? "checked='checked'" : ""}>
                            <g:message code="enable.ticket.purchase"/>
                        </div>
                        ...
                        <g:set var="hasSession" value="${event && event.eventSessions?.size()}"/>
                        <g:if test="${!hasSession}">
                            <div class="form-row">
                            ...
                            <div class="double-input-row">
                                <div class="form-row mandatory">
                                    ...
                                    <input type="text" id="${startTime}" class="timefield large" name="startTime" validation="required"
                                           value="${event.startTime?.toDatePickerFormat(true, session.timezone)}"/>
                                ...
                                <g:each in="${event?.images}" var="image">
                                    <div image-id="${image.id}" image-name="${image.name}" class="image-thumb">
                                        ...
                                        <div class="image-container">
                                            <img src="${app.customResourceBaseUrl()}resources/event/event-${event?.id}/images/100-${image.name}">
                                        </div>
                                    </div>
                                </g:each>
                            </div>
