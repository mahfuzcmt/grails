    ...
    <g:if test="${request.page}">
        <%
            if(!request.is_fullcalendar_loaded) {
                request.js_cache.push("plugins/event-management/fullcalendar/fullcalendar.min.js")
                request.css_cache.push("plugins/event-management/fullcalendar/fullcalendar.css")
                request.is_fullcalendar_loaded = true;
            }

            if(!request.is_event_widget_calendar_script_loaded) {
                request.js_cache.push("plugins/event-management/js/widget/calendar-widget.js")
        ...
        <script type="text/javascript">
            $(function() {
                bm.onReady(app, "initCalendarWidget", function() {
                    var config = {};
                    ...
                    app.initCalendarWidget($('#calendar-' + '${id}'), config, eventDataList);
                })
            })
        </script>
    </g:if>
