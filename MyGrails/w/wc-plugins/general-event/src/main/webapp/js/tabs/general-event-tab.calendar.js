/**
 * Created by arman on 1/4/2016.
 */
bm.onReady(app.tabs, "generalEvent", function() {
    app.tabs.generalEvent.Calendar = function (content, parentTab) {
        this.body = content;
        this.parentTab = parentTab;
    };

    var _ct =  app.tabs.generalEvent.Calendar.prototype;
