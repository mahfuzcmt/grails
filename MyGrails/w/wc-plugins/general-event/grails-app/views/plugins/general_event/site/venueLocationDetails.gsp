    ...
    <div class="upper-container">
        <div class="upper-left-container">
            <div class="location-image-container">
                ...
                <div class="image-preview-box location-image-preview-box">
                    <div class="vertical-aligner"></div><img src="${app.customResourceBaseUrl()}resources/general-event-venue-location/${imgPath}">
                </div>
                    ...
                    <div class="multi-image-scroll-wrapper">
                        ...
                        <div class="image-thumb-container location-thumb-view">
                            <g:each in="${location.images}" var="image">
                                <g:set var="originalSrc" value="${app.customResourceBaseUrl()}resources/general-event-venue-location/location-${location?.id}/300-${image.name}"/>
                                <span class="location-thumb-image" name="${image.name}" original-src="${originalSrc}">
                                    <div class="vertical-aligner"></div><img src="${app.customResourceBaseUrl()}resources/general-event-venue-location/location-${location?.id}/100-${image.name}">
                                </span>
                            </g:each>
                        </div>
                    </div>
        ...
        <div class="upper-right-container image-container">
            <div class="venue-location-details">
                <g:if test="${location.venue.generalAddress}">
                    <div class="address">
                        <span class="address">${location.venue.generalAddress.encodeAsBMHTML()}</span>
                    </div>
                </g:if>
        ...
        <div class="bmui-tab">
            <div class="bmui-tab-header-container">
                ...
                <g:each in="${location.sections}" var="section" status="i">
                    <div class="bmui-tab-header" data-tabify-tab-id="section-${i}" data-tabify-url="${app.relativeBaseUrl()}generalEvent/seatMap?section=${section.id}">
