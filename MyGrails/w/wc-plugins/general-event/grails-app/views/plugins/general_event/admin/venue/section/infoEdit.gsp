<form action="${app.relativeBaseUrl()}generalEventAdmin/saveVenueLocationSection" method="post" class="create-edit-form location-section-create-form">
        ...
        <div class="form-section-container">
            ...
            <div class="double-input-row">
                <div class="form-row">
                    ...
                    <input type="text" name="rowAccessBetween" class="large" value="${section.rowAccessBetween}" restrict="numeric" validation="compare[${rowCount}, number, lte]" ${ticketExists ? 'disabled' : ''}>
                </div>
            </div>
