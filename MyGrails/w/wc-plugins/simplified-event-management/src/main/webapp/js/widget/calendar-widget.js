$(function() {
    app.initCalendarWidgetForSimplifiedEvent = function(container, config, eventDataList) {
        ...
        function eventSummary(events) {
            ...
            $.each(events, function(idx, event) {
                ...
                var imgPath = app.baseUrl + 'resources/simplified-event/' + (event.image ? 'event-' + event.id + '/images/100-' + event.image : 'default/100-default.png');
                ...
                if(config.showBookNow) {
                    ...
                    buttonLine.append('<span><a href="' + app.baseUrl + 'simplifiedEvent/' + event.id + '" class="button book-now">' + btnLabel +
                        '</a></span>');
                }
