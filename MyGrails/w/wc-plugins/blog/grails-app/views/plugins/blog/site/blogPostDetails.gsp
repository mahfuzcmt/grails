        ...
        <div class="post-description">
            ...
            <g:if test="${config.comment_restriction != 'D'}">
                <div class="blog-post-comment-panel">
                    <g:include view="/plugins/blog/site/commentList.gsp" model="[comments: comments, count: count, url : url]"/>
                </div>
                ...
                <g:else>
                    <span class='loging-to-react' data-purpose="<g:message code="to.comment"/>" data-url="${url}"><g:message code="post.comment"/> </span>
                </g:else>
            </g:if>
        </div>
    </div>
