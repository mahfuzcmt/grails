    ...
    <div class="form-section">
        ...
        <div class="form-section-container">
            <div class="form-row">
                ...
                <input type="checkbox" class="multiple" name="blog.post_category_breadcrumb" value="true" uncheck-value="false"  ${config.post_category_breadcrumb == "true" ? "checked" : ""}>
                <span class="value"><g:message code="show.category.breadcrumb"/></span>
            </div>
