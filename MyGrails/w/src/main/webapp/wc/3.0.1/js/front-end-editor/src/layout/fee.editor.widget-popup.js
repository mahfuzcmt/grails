...
/*        "            <div class=\"fee-pu-widget-tab fee-pu-widget-navigation\" data-widget-type=\"navigation\">\n" +
        ...
        "                <span class=\"fee-pu-lo-icon\"><img src=\"" + app.systemResourceUrl + "images/front-end-editor/2-column.png\" alt=\"\"></span>\n" +
        "                <span class=\"fee-pu-lo-label\">2 Column section</span>\n" +
        "            </div>\n" +
        "            <div class=\"fee-pu-layout\" data-type=\"threeColumn\">\n" +
        "                <span class=\"fee-pu-lo-icon\"><img src=\"" + app.systemResourceUrl + "images/front-end-editor/3-column.png\" alt=\"\"></span>\n" +
        "                <span class=\"fee-pu-lo-label\">3 Column section</span>\n" +
        "            </div>\n" +
        "            <div class=\"fee-pu-layout\" data-type=\"spacer\">\n" +
        "                <span class=\"fee-pu-lo-icon\"><img src=\"" + app.systemResourceUrl + "images/front-end-editor/spacer.png\" alt=\"\"></span>\n" +
    ...
    var postInit = {
                        ...
                        success: function (resp) {
                            if (widgetInst.afterSave) {
                                ...
                                if (resp.status = "success") {
                                    ...
                                    bm.notify($.i18n.prop(resp.message), "error");
                                }
                            }
                        },
                        error: function (jqXHR, textStatus, errorThrown) {
                            bm.notify($.i18n.prop(errorThrown.message), "error");
                        }
                    });
        ...
        imageWidgetPopulate: function () {
            ...
            popupElement.find('.fee-pu-body').find('.fee-save').attr("disabled", 'disabled');
            imageForm.find("input[type='file']").on("change", function () {
                popupElement.find(".preview-image").fadeIn();
                popupElement.find(".image-edit-button").remove();
                if (this.files && this.files[0]) {
                    ...
                    FR.onload = function () {
                        ...
                        popupElement.find('.fee-pu-body').find('.fee-save').removeAttr('disabled');
                    };
