app.FrontEndEditor = function () {
    ...
    if(isIE) {
        ...
        currentUrl = currentUrl.split("editor")[0];
        var warningText = "Frontend Editor is not supported in Internet Explorer";
        var dom = "<h2>" + warningText + "</h2> <a href=" + currentUrl + ">back to frontend</a>";
        document.write(dom);
        return;
    }
