...
class CustomerController {
    ...
    def loadAvailablePage() {
        ...
        def assignedPagesLabel = AppUtil.getConfig(DomainConstants.SITE_CONFIG_TYPES.CUSTOMER_PROFILE_PAGE,"assigned_pages_label")
        render(view: "/site/autopage/customerProfile/availablePage", model: [pages: pages, assignedPagesLabel:assignedPagesLabel])
    }
