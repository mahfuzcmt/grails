<form action="${app.relativeBaseUrl()}pageAdmin/loadAppView" class="edit-popup-form">
    <div class="form-row">
    ...
    <div class="form-row">
        ...
        <input type="text" class="large" name="title" value="${params.searchText}"/>
    </div>
    <div class="form-row">
        <label><g:message code="visibility"/></label>
        <g:select class="large" name="visibility" from="['Any', 'Open', 'Hidden', 'Restricted']" keys="['', 'open', 'hidden', 'restricted']"></g:select>
    </div>
