...
<div class="component-config picking_slip_table">
    <div class="title-bar">
    ...
    <div class="config-body">
        ...
        <table>
            ...
            <tbody>
            <g:set var="componentConfig" value="${config ?: NamedConstants.PICKING_SLIP_TABLE_COLUMN}"/>
            <g:set var="constantColumn" value="${["Product Name", "Ordered Quantity"]}"/>
            <g:each in="${componentConfig}" var="header" status="i">
                <tr class="picking-slip-column">
                    <td class="name">
                    ...
                    <td class="value">
                        <g:select name="value-${header.key}" disabled="${constantColumn.contains(header.key)}" from="${NamedConstants.PICKING_SLIP_TABLE_COLUMN.collect {it.key}}" keys="${NamedConstants.PICKING_SLIP_TABLE_COLUMN.collect {it.value}}" value="${params['value-'+header.key] ?: header.value}"/>
