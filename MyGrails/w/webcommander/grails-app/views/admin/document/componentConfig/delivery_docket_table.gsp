...
<div class="component-config delivery_docket_table">
    <div class="title-bar">
    ...
    <div class="config-body">
        ...
        <table>
            ...
            <tbody>
            <g:set var="componentConfig" value="${config ?: NamedConstants.DELIVERY_DOCKET_TABLE_COLUMN}"/>
            <g:set var="constantColumn" value="${["Product Name", "Quantity Ordered", "Quantity Shipped"]}"/>
            <g:each in="${componentConfig}" var="header" status="i">
                <tr class="delivery-docket-column">
                    <td class="name">
                    ...
                    <td class="value">
                        <g:select name="value-${header.key}" disabled="${constantColumn.contains(header.key)}" from="${NamedConstants.DELIVERY_DOCKET_TABLE_COLUMN.collect {it.key}}" keys="${NamedConstants.DELIVERY_DOCKET_TABLE_COLUMN.collect {it.value}}" value="${params['value-'+header.key] ?: header.value}"/>
