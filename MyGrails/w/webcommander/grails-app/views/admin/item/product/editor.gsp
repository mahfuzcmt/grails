...
<g:set var="isMultiStoreEnabled" value="${AppUtil.getConfig(DomainConstants.SITE_CONFIG_TYPES.ADMINISTRATION, "enable_multi_model") == "true"}"/>
<div class="bmui-tab left-side-header create-edit-panel">
    <div class="bmui-tab-header-container">
        ...
        <g:if test="${isMultiStoreEnabled}">
            <div class="bmui-tab-header" data-tabify-tab-id="multiStore" data-tabify-url="${app.relativeBaseUrl()}productAdmin/loadProductProperties?id=${productId}&property=multiStore">
                <span class="title"><g:message code="multi.store"/></span>
            </div>
        </g:if>
