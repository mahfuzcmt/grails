...
<g:set var="configType" value="${DomainConstants.SITE_CONFIG_TYPES['SHIPPING_ADDRESS_FIELD']}"/>
<g:set var="configs" value="${AppUtil.getConfig(DomainConstants.SITE_CONFIG_TYPES.SHIPPING_ADDRESS_FIELD)}"/>
<input type="hidden" name="type" value="${configType}">
<g:set var="fields" bean="configService"/>
<div class="form-section">
    <div class="form-section-info">
        <h3><g:message code="shipping.address.form.fields"/></h3>
        <div class="info-content"><g:message code="section.text.shipping.address.form.field.info"/></div>
    </div>
                ...
                <div class="configurable-row row-wcui-checkbox-right child-child  ${active == null || active ? 'active' : 'active'}">
                    ...
                    <span class="edit-block">
                        <g:if test="${active != null}">
                            <input class="active row-wcui-checkbox-right single" type="checkbox" name="${configType}.${field}_active" value="true" uncheck-value="false"
