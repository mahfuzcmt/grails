...
<form action="${app.relativeBaseUrl()}setting/saveConfigurations" method="post" class="create-edit-form administration-edit-form">
    ...
    <div class="form-section">
        <div class="form-section-info">
            <h3><g:message code="multi.model"/></h3>
            <div class="info-content"><g:message code="section.text.setting.multi.model.info"/></div>
        </div>
        <div class="form-section-container">
            <div class="form-row">
                <input type="checkbox" class="single multi-model" name="${type}.enable_multi_model" value="true" uncheck-value="false" ${config.enable_multi_model == "true" ? "checked='checked'" : ""}>
                <span><g:message code="multi.model" /></span>
            </div>
        </div>
    </div>
