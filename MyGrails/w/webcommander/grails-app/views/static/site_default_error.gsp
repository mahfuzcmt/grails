...
<html>
    ...
    <body style="height: 100%; margin: 0px; text-align: center;">
        ...
        <div style="height: 300px; width: 800px; border: 1px solid #E6E6E6; display: inline-block; *display: inline; zoom: 1; vertical-align: middle;box-shadow: 0 0 5px #CCCCCC;">
            <div style="color: #5555FF; text-align: center; font-size: 30px; height: 60px; padding-top: 20px; border-bottom: 1px solid #CCCCCC; background-color: #F4F4F4;">
                404 <g:message code="page.not.found"/> !
            </div>
            <div style="padding: 30px; text-align: center">
                <g:message code="not.found.page.text"/> <a href="${app.relativeBaseUrl()}"><g:message code="home.page"/></a>.
            </div>
        </div>
    </body>
</html>