...
<div>
    ...
    <div class="body">
        ...
        <g:if test="${associatedWithMultipleStore.size() && (AppUtil.getConfig(DomainConstants.SITE_CONFIG_TYPES.ADMINISTRATION, "enable_multi_model") == "true")}">
            <h4 class='title'><g:message code="select.store"/></h4>
            <g:select class="store-selection" name="storeId" from="${associatedWithMultipleStore*.store}" optionKey="id" optionValue="location" />
        </g:if>
