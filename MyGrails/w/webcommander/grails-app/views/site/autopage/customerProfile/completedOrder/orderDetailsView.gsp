...
<div class="panel-header">
    ...
    <div class="header-right">
        ...
        <span class="link-btn add-all-to-cart" data-id="${order.id}"><g:message code="add.all.to.cart"/></span>
        <span class="link-btn back-button"><g:message code="back.to.list"/></span>
    </div>
</div>
<div id="order-details" customer-id="${order.customerId}">
    <div class="order-items-wrap">
        <table>
            <colgroup>
                <col class="product-col">
                <col class="addcart-col">
            ...
            <g:each in="${order.items}" var="item">
                ...
                <tr>
                    <td>
                        ...
                        <plugin:hookTag hookPoint="completedOrderDetailsProductColumn" attrs="${[cartItem: item]}"/>
                    </td>
                    <td><div class="wrapper" data-label="<g:message code="add.cart"/>:"><span class="action-icon add-to-cart"
                         title="<g:message code="add.to.cart"/>"data-id="${order.id}" data-item-id="${item.id}"></span></div></td>
    ...
    <div class="order-info-wrap">
        ...
        <div class="info-row total-amount-row">
