    ...
    <div class="multi-column two-column">
        <div class="columns first-column">
            <div class="column-content selection-panel table-view">
                <g:include controller="manufacturerAdmin" action="loadManufacturerForSelection"/>
            </div>
            ...
            <div class="column-content selected-panel table-view">
                    ...
                    <table>
                        ...
                        <g:each in="${manufacturers}" var="manufacturer">
                            <tr>
                                ...
                                <td class="actions-column" item="${manufacturer.id}" type="manufacturer">
                                    ...
                                    <input type="hidden" name="${fieldName}" value="${manufacturer.id}">
                                </td>
                            </tr>
                        </g:each>
                    </table>
                ...
                <div class="footer">
                    <paginator total="${manufacturers.size()}" offset="0" max="${10}"></paginator>
                </div>
                <div class="hidden">
