...
<g:set var="configType" value="${DomainConstants.SITE_CONFIG_TYPES['BILLING_ADDRESS_FIELD']}"/>
<g:set var="configs" value="${AppUtil.getConfig(DomainConstants.SITE_CONFIG_TYPES.BILLING_ADDRESS_FIELD)}"/>
<input type="hidden" name="type" value="${configType}">
<g:set var="fields" bean="configService"/>
<div class="form-section">
    <div class="form-section-info">
        <h3><g:message code="billing.address.form.fields"/></h3>
        <div class="info-content"><g:message code="section.text.billing.address.form.field.info"/></div>
    </div>
