...
<div class="component-config invoice_table">
    <div class="title-bar">
    ...
    <div class="config-body">
        ...
        <table>
            ...
            <tbody>
            <g:set var="componentConfig" value="${config ?: NamedConstants.INVOICE_TABLE_COLUMN}"/>
            ...
            <g:each in="${componentConfig}" var="header" status="i">
                <tr class="invoice-column">
                    ...
                    <td class="value">
                        <g:select name="value-${header.key}" disabled="${constantColumn.contains(header.key)}" from="${NamedConstants.INVOICE_TABLE_COLUMN.collect {it.key}}" keys="${NamedConstants.INVOICE_TABLE_COLUMN.collect {it.value}}" value="${params['value-'+header.key] ?: header.value}"/>
