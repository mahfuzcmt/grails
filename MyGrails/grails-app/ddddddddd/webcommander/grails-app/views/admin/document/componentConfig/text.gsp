...
<div class="component-config text">
    <div class="title-bar">
    ...
    <div class="config-body">
        ...
        <div class="form-row inline-element">
            ...
            <span class="value">${params.backgroundColor ?: 'transparent'}</span>
            <input type="text" class="color-picker" name="backgroundColor" value="${params.backgroundColor ?: ''}">
        </div>
        <div class="form-row inline-element">
