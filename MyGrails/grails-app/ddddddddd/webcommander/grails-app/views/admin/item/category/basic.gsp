    ...
    <div class="form-section">
        ...
        <div class="form-section-container">
            ...
            <div class="form-row">
                ...
                <textarea class="wceditor no-auto-size xx-larger" name="description" toolbar-type="advanced" validation="maxlength[2000]" maxlength="2000">${category.description}</textarea>
            </div>
