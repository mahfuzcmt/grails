...
<form action="${app.relativeBaseUrl()}pageAdmin/save" method="post" class="create-edit-form">
    <div class="bmui-tab">
                        ...
                        <div class="form-section-container">
                            ...
                            <div class="double-input-row">
                                <div class="form-row">
                                    ...
                                    <input type="text" name="url" class="large unique" value="${page.url}" validation="rangelength[2, 50] url_folder">
