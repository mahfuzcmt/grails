...
class OrderService {
    ...
    def sendEmailForOrder(Long orderId, String identifier, String comment = null) {
        ...
        Map macrosAndTemplate = commanderMailService.getMacrosAndTemplateByIdentifier(identifier)
        ...
        if(macrosAndTemplate.emailTemplate.active) {
            ...
            commanderMailService.sendMail(macrosAndTemplate.emailTemplate, macrosAndTemplate.activeHtml, macrosAndTemplate.activeText, refinedMacros, order.billing.email, null, htmlMacros, textMacros, attachments)}
        }
    }
