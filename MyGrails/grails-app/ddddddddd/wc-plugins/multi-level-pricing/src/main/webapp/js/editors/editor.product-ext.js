(function() {
    var _ep = app.editProduct;
    var priceAndQuantity = _ep.tabInitFunctions["price-quantity"];
    ...
    _ep.tabInitFunctions["price-quantity"]  = function (panel) {
        priceAndQuantity.apply(this, arguments);
