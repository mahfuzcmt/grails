...
<form action="${app.relativeBaseUrl()}myob/saveConfigurations" method="post" class="create-edit-form">
    ...
    <div class="form-section">
        ...
        <div class="form-section-info">
            ...
            <div class="info-content"><g:message code="section.text.myob.payment.account"/></div>
        </div>
        <div class="form-section-container">
            <div class="form-row">
                ...
                <div class="radio-group horizontal">
                    <div class="radio">
                        <input type="radio" class="single" name="myob.order_sync_type" value="detail" toggle-target="detail-panel" ${config.order_sync_type == "detail" ? "checked='checked'" : ""}>
                        <label><g:message code="detail"/></label>
                    </div>
                    <div class="radio">
                        <input type="radio" class="single" name="myob.order_sync_type" value="summary" ${config.order_sync_type == "summary" ? "checked='checked'" : ""}>
            ...
            <div class="form-row chosen-wrapper">
                ...
                <g:select from="${accounts}" optionKey="code" optionValue="name" name="myob.default_payment_account" value="${config.default_payment_account ?: null}"/>
            </div>
