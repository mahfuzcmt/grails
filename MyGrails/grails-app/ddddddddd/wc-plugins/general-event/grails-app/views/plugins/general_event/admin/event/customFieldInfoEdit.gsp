<%@ page import="com.webcommander.util.StringUtil; com.webcommander.plugin.general_event.constants.DomainConstants" %>
<form class="edit-popup-form create-edit-form product-custom-filed-create-form" action="${app.relativeBaseUrl()}generalEventAdmin/saveCustomField">
        ...
        <div class="form-section-container">
            <div class="double-input-row">
                <div class="form-row chosen-wrapper">
                    ...
                    <g:select name="type" from="${DomainConstants.EVENT_CHECKOUT_FIELD_TYPE.values().collect {g.message(code: it)}}" keys="${DomainConstants.EVENT_CHECKOUT_FIELD_TYPE.values()}"
