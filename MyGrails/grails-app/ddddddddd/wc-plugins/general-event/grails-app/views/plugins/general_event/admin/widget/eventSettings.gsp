<g:form class="edit-popup-form create-edit-form" controller="widget" action="saveGeneralEventWidget">
        ...
        <div class="form-section-container">
            ...
            <div class="selection-panel">
                <g:if test="${config.selectionType == 'event'}">
                    <g:include view="plugins/general_event/admin/widget/eventSelectionPanel.gsp" model="[selectedEvents: selectedEvents]"/>
                </g:if>
            </div>
