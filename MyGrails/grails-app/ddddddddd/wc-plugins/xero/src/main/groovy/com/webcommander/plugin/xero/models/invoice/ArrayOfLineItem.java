...
public class ArrayOfLineItem {
    ...
    protected List<XeroLineItem> lineItem;
     ...
     * 
     */
    public List<XeroLineItem> getLineItem() {
        if (lineItem == null) {
            lineItem = new ArrayList<XeroLineItem>();
        }
        return this.lineItem;
    }

    public void setLineItem(List<XeroLineItem> lineItem) {
        this.lineItem = lineItem;
    }

    public void addLineItem(XeroLineItem xeroLineItem) {
        if (lineItem == null) {
            lineItem = new ArrayList<XeroLineItem>();
        }
        lineItem.add(xeroLineItem);
    }
}
