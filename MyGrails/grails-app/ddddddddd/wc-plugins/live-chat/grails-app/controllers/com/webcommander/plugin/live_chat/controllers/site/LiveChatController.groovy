...
class LiveChatController {
    ...
    def initChat() {
        String askForInfo = AppUtil.getConfig(DC.SITE_CONFIG_TYPES.LIVE_CHAT, "ask_for_info")
        ...
        render(view: "/plugins/live_chat/site/liveChat/initChat", model: [agentCount: AgentManager.agentCount])
    }
    ...
    def chatLeave() {
        ...
        if(chatData) {
            ...
            liveChatService.leaveChat(chatData);
        }
        session.live_chat_ref = null
        render([status: "success"] as JSON)
    }
