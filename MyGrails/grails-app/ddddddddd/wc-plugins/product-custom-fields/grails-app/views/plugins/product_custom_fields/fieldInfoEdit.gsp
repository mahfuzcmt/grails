<%@ page import="com.webcommander.util.StringUtil; com.webcommander.plugin.product_custom_fields.DomainConstants" %>
<form class="edit-popup-form create-edit-form product-custom-filed-create-form" action="${app.relativeBaseUrl()}productCustomField/saveField">
    <div class="form-section">
        <div class="form-section-info">
            <h3><g:message code="custom.field.info"/></h3>
            <div class="info-content"><g:message code="section.text.product.custom.field"/></div>
        </div>
        <div class="form-section-container">
            <div class="double-input-row">
                <div class="form-row chosen-wrapper">
                    <label><g:message code="type"/><span class="suggestion"> e.g. Long Text</span> </label>
                    <g:select name="type" from="${DomainConstants.PRODUCT_CHECKOUT_FIELD_TYPE.values().collect {g.message(code: it.replaceAll("_", "."))}}" keys="${DomainConstants.PRODUCT_CHECKOUT_FIELD_TYPE.values()}"
            ...
            <input type="hidden" name="${params.type}.id" value="${field[params.type].id}">
            <input type="hidden" name="entityType" value="${params.type}">
        </div>
    </div>
    <div class="form-section-separator field-type-long_text field-type-text"></div>
    <div class="form-section field-type-long_text field-type-text">
        <div class="form-section-info">
            <h3><g:message code="validation"/></h3>
            <div><g:message code="section.text.product.custom.field.validation"/> </div>
        </div>
