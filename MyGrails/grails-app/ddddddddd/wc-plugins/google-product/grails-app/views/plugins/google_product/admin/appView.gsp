...
<div class="app-tab-content-container">
    <div class="three-column multi-column">
        <div class="first-column columns">
            <h3><g:message code="google.product"/></h3>
            <div class="info-content"><g:message code="section.text.google.product.info"/></div>
            ...
            <div class="column-content right-panel panel tree-panel with-title">
                <div class="tree-title"><g:message code="google.category"/> </div>
                <div class="google-category-tree body"></div>
            </div>
        </div>
    </div>
</div>
