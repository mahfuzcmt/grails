            ...
            configForm.form({
                ...
                preSubmit: function (ajaxSettings) {
                        ...
                        success: function (resp) {
                            if (widgetInst.afterSave) {
                                ...
                                if (resp.status = "success") {
                                    ...
                                    editorInstance.cachedWidgetData[uuid]['serialized'] = JSON.parse(resp.serialized);
                    ...
                    var beforeSubmit = function (data) {
                        ...
                        var _containerId = editorInstance.pageId;
                        var _containerType = "page";

                        var _widget = widgetElm[0];
                        if(_self.common.isInLayout(_widget)){
                            _containerId = _self.layout_id;
                            _containerType = 'layout';
                        }
                        data.pushAll([
                            {
                                name: "widgetId",
