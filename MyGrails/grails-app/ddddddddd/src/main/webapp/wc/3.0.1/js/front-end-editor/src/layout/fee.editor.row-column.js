...
app.FrontEndEditor.prototype.rowColumnCss = (function (configs) {
    ...
    return {
        ...
        getInlineElementIds: function () {
            ...
            return inlineElementIds;
        },

        background: function (type, value, isTemporaryChange) {
            var _this = this;
            var inlineElementIds = _this.getInlineElementIds();
            ...
            function applyBackground(elementId) {
                ...
                if (type === app.FrontEndEditor.floatingMenu.BACKGROUND_TYPE.COLOR) {
                    ...
                    if (backgroundPosition === 'center') {
                        ...
                        backgroundCss['background-size'] = "none";
                    }
        ...
        backgroundPosition: function (value) {
            ...
            $.each(inlineElementIds, function (index, eleId) {
                styleBuilder.update(defaults.cssParser, null, eleId, backgroundCss);
            });
            _self.events.save();
        },
        ...
        backgroundRepeat: function (value) {
            ...
            $.each(inlineElementIds, function (index, eleId) {
                styleBuilder.update(defaults.cssParser, null, eleId, {'background-repeat': value});
            });
            _self.events.save();
        },
        ...
        bindColorPicker: function () {
            ...
            colorPickerSelector.ColorPicker({
                ...
                onChange: function (hsb, hex, rgb) {
                    ...
                    _this['background'].apply(_this, [app.FrontEndEditor.floatingMenu.BACKGROUND_TYPE.COLOR, hex, true]);
                },
                onSubmit: function (hsb, hex, rgb, el) {
                    // $(el).ColorPickerHide();
                    _this['background'].apply(_this, [app.FrontEndEditor.floatingMenu.BACKGROUND_TYPE.COLOR, hex]);
                }
            });
        },
        ...
        bindImageUpload: function () {
            ...
            defaults.floatingMenuElement.find(".fee-background-upload-field").on("change", function () {
                if (this.files && this.files[0]) {
                    ...
                    var ajaxUrl = app.baseUrl + 'app/uploadWceditorImage';
                    bm.ajax({
                        url: ajaxUrl,
                        data: formData,
                        type: 'post',
                        ...
                        success: function (response) {
                            _self['background'].apply(_self, [app.FrontEndEditor.floatingMenu.BACKGROUND_TYPE.IMAGE, response.url]);
                        }
                    });
                }
            });
